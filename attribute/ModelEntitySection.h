...
#ifndef __slctk_attribute_ModelEntitySection_h
#define __slctk_attribute_ModelEntitySection_h
...
namespace slctk
{
  namespace attribute
  {
    class SLCTKATTRIBUTE_EXPORT ModelEntitySection : public Section
    {
    public:
...
#endif /* __slctk_attribute_ModelEntitySection_h */
