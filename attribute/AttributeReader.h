...
#ifndef __slctk_attribute_AttributeReader_h
#define __slctk_attribute_AttributeReader_h
...
namespace slctk
{
  ...
  {
    class Manager;
    class SLCTKATTRIBUTE_EXPORT AttributeReader
    {
    public:
...
#endif /* __slctk_attribute_AttributeReader_h */
