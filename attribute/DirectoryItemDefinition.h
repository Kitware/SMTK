...
#ifndef __slctk_attribute_DirectoryItemDefinition_h
#define __slctk_attribute_DirectoryItemDefinition_h
...
namespace slctk
{
  namespace attribute
  {
    class Attribute;
    class Definition;
    class SLCTKATTRIBUTE_EXPORT DirectoryItemDefinition:
...
#endif /* __slctk_attribute_DirectoryItemDefinition_h */
