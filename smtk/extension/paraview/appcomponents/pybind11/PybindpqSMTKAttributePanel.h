...
inline py::class_< pqSMTKAttributePanel, QDockWidget > pybind11_init_pqSMTKAttributePanel(py::module &m)
{
  py::class_< pqSMTKAttributePanel, QDockWidget > instance(m, "pqSMTKAttributePanel");
  instance
    .def(py::init<::QWidget *>())
    ...
    .def("displayResource", &pqSMTKAttributePanel::displayResource, py::arg("rsrc"), py::arg("view") = nullptr)
    .def("displayResourceOnServer", &pqSMTKAttributePanel::displayResourceOnServer, py::arg("rsrc"), py::arg("view") = nullptr)
