...
void smtkExportModelView::mouseMoveEvent(QMouseEvent* event)
{
  (void)event;
  //std::cout << "Urf\n";
}
...
void smtkExportModelView::updateSummary(const std::string& mode)
{
  ...
  if (action)
  {
    //this->Internals->ExportSummaryLabel->setText(action->m_saveErrors.str().c_str());
    std::string summary;
