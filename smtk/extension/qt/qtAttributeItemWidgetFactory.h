...
public:
  ...
  virtual qtItem* createRefItemWidget(
    attribute::RefItemPtr item, QWidget* p, qtBaseView* bview, Qt::Orientation orient);
  virtual qtItem* createValueItemWidget(
    attribute::ValueItemPtr item, QWidget* p, qtBaseView* bview, Qt::Orientation orient);
  virtual qtItem* createDirectoryItemWidget(
    attribute::DirectoryItemPtr item, QWidget* p, qtBaseView* bview, Qt::Orientation orient);
  virtual qtItem* createFileItemWidget(
    attribute::FileItemPtr item, QWidget* p, qtBaseView* bview, Qt::Orientation orient);
  virtual qtItem* createGroupItemWidget(
