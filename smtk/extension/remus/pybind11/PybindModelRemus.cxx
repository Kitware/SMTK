...
PYBIND11_MODULE(_smtkPybindModelRemus, remus)
{
  ...
  // PySharedPtrClass< smtk::model::MeshOperation, smtk::operation::Operation > smtk_extension_remus_MeshOperation = pybind11_init_smtk_extension_remus_MeshOperator(remus);
