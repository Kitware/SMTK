...
//=========================================================================
#ifndef __smtk_extension_remus_MeshOperation_h
#define __smtk_extension_remus_MeshOperation_h
...
/**\brief Mesh a model using remus.
  ...
  *
  */
class SMTKREMUSEXT_EXPORT MeshOperation : public smtk::operation::XMLOperation
{
public:
  smtkTypeMacro(MeshOperation);
  smtkCreateMacro(MeshOperation);
