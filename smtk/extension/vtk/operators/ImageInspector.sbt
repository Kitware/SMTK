...
<SMTK_AttributeResource Version="3">
  <Definitions>
    ...
    <AttDef Type="smtk::geometry::ImageInspector" Label="Image Inspector" BaseType="operation">
      <BriefDescription>Inspect the interior of a volumetric image with a planar slice.</BriefDescription>
      <DetailedDescription>
        This tool simply displays the selected components' geometry sliced by
      ...
      <AssociationsDef Name="source" Label="Inputs" NumberOfRequiredValues="1" Extensible="yes">
        <BriefDescription>The volume image(es) to inspect.
...
Return key toggles unsliced component visibility.</BriefDescription>
    ...
    <AttDef Type="result(smtk::geometry::ImageInspector)" BaseType="result"/>
  </Definitions>
  <Views>
    <View Type="smtkMeshInspectorView" Title="Image Inspector"
      FilterByAdvanceLevel="false" FilterByCategoryMode="false"
      FilterByCategory="false" IgnoreCategories="true">
      <AttributeTypes>
        <Att Type="smtk::geometry::ImageInspector" Name="Image inspector">
          <ItemViews>
