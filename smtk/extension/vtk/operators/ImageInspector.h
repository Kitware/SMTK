...
//=========================================================================
#ifndef smtk_geometry_ImageInspector_h
#define smtk_geometry_ImageInspector_h
 ...
 */
class VTKSMTKOPERATIONSEXT_EXPORT ImageInspector : public smtk::operation::XMLOperation
{
public:
  smtkTypeMacro(smtk::geometry::ImageInspector);
  smtkCreateMacro(ImageInspector);
...
#endif //smtk_geometry_ImageInspector_h
