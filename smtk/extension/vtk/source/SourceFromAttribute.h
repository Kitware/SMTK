...
#ifndef smtk_extensions_vtk_source_SourceFromAttribute_h
#define smtk_extensions_vtk_source_SourceFromAttribute_h
#ifndef __VTK_WRAP__
...
class VTKSMTKSOURCEEXT_EXPORT SourceFromAttribute
  : public smtk::common::
      GeneratorType<smtk::resource::ResourcePtr, vtkSmartPointer<vtkAlgorithm>, SourceFromAttribute>
{
public:
