...
PYBIND11_MODULE(_smtkPybindVTKSourceFns, source)
{
  ...
  source.def("_vtkResourceMultiBlockSource_GetComponent",[&](vtkResourceMultiBlockSource* obj, vtkInformation* info){ return std::dynamic_pointer_cast<smtk::resource::Component>(obj->GetComponent(info)); });
