...
PYBIND11_MODULE(_smtkPybindVTKSourceFns, source)
{
  ...
  source.def("_vtkModelMultiBlockSource_GetDataObjectUUID",[&](vtkModelMultiBlockSource* obj, vtkInformation* info){ return vtkModelMultiBlockSource::GetDataObjectUUID(info); });
  source.def("_vtkModelMultiBlockSource_SetDataObjectUUID",[&](vtkModelMultiBlockSource* obj, vtkInformation* info, const smtk::common::UUID& id){ return vtkModelMultiBlockSource::SetDataObjectUUID(info, id); });
  ...
  source.def("_vtkMeshMultiBlockSource_GetDataObjectUUID",[&](vtkMeshMultiBlockSource* obj, vtkInformation* info){ return vtkMeshMultiBlockSource::GetDataObjectUUID(info); });
  source.def("_vtkMeshMultiBlockSource_SetDataObjectUUID",[&](vtkMeshMultiBlockSource* obj, vtkInformation* info, const smtk::common::UUID& id){ return vtkMeshMultiBlockSource::SetDataObjectUUID(info, id); });
