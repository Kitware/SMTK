...
#ifndef smtk_extensions_vtk_source_SourceFromMesh_h
#define smtk_extensions_vtk_source_SourceFromMesh_h
#ifndef __VTK_WRAP__
...
class VTKSMTKSOURCEEXT_EXPORT SourceFromMesh
  : public smtk::common::
      GeneratorType<smtk::resource::ResourcePtr, vtkSmartPointer<vtkAlgorithm>, SourceFromMesh>
{
public:
