...
PySharedPtrClass< smtk::view::DescriptivePhrase > pybind11_init_smtk_view_DescriptivePhrase(py::module &m)
{
  ...
  instance
    ...
    .def("argFindChild", (int (smtk::view::DescriptivePhrase::*)(::smtk::resource::ResourcePtr, bool) const) &smtk::view::DescriptivePhrase::argFindChild, py::arg("child"), py::arg("onlyResource") = true)
    .def("argFindChild", (int (smtk::view::DescriptivePhrase::*)(::smtk::resource::ComponentPtr) const) &smtk::view::DescriptivePhrase::argFindChild, py::arg("child"))
