...
PYBIND11_MODULE(_smtkPybindMultiscaleSession, multiscale)
{
  ...
  PySharedPtrClass< smtk::session::multiscale::Resource, smtk::model::Resource > smtk_session_multiscale_Resource = pybind11_init_smtk_session_multiscale_Resource(multiscale);
