...
vtkStandardNewMacro(vtkCMBIncorporateMeshOperation);

vtkCMBIncorporateMeshOperation::vtkCMBIncorporateMeshOperation()
{
...
void vtkCMBIncorporateMeshOperation::Operate(vtkDiscreteModelWrapper* modelWrapper)
{
...
void vtkCMBIncorporateMeshOperation::AddSolidMesh(
...
void vtkCMBIncorporateMeshOperation::AddSolidMesh(vtkIdType meshRegionId, vtkAlgorithm* algOut)
{
  if (algOut)
  {
...
void vtkCMBIncorporateMeshOperation::ClearSolidMeshes()
{
  this->SolidMeshes.clear();
}

bool vtkCMBIncorporateMeshOperation::IncorporateSolidMesh(
  vtkDiscreteModel* meshModel, const vtkIdType& meshRegionId, vtkPolyData* solidRegionSurface)
{
  ...
  vtkNew<vtkCMBModelBuilder> builderOperation;
  vtkNew<vtkDiscreteModelWrapper> modelWrapper;
  builderOperation->Operate(modelWrapper.GetPointer(), mergeDuplicateCells.GetPointer());
  if (!builderOperation->GetOperateSucceeded())
  {
    return false;
  }
...
bool vtkCMBIncorporateMeshOperation::SplitMeshRegion(
...
bool vtkCMBIncorporateMeshOperation::CreateNewMeshRegions(vtkDiscreteModel* solidModel,
...
void vtkCMBIncorporateMeshOperation::AddSolidFaceCells(vtkDiscreteModel* meshModel,
...
vtkIdType vtkCMBIncorporateMeshOperation::FindPointsCell(const DiscreteMesh* targetMesh,
...
bool vtkCMBIncorporateMeshOperation::IsSameCellPoints(const DiscreteMesh* targetMesh,
...
void vtkCMBIncorporateMeshOperation::PrintSelf(ostream& os, vtkIndent indent)
{
