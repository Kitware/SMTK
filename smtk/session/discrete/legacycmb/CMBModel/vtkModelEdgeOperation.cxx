...
#include "vtkModelEdgeOperation.h"
...
vtkStandardNewMacro(vtkModelEdgeOperation);

vtkModelEdgeOperation::vtkModelEdgeOperation()
{
}
...
bool vtkModelEdgeOperation::AbleToOperate(vtkDiscreteModelWrapper* ModelWrapper)
{
  if (!ModelWrapper)
  {
...
void vtkModelEdgeOperation::Operate(vtkDiscreteModelWrapper* ModelWrapper)
{
...
void vtkModelEdgeOperation::PrintSelf(ostream& os, vtkIndent indent)
{
