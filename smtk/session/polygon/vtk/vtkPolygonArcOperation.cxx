...
#include "smtk/session/polygon/vtk/vtkPolygonArcOperation.h"
...
bool vtkPolygonArcOperation::AbleToOperate()
{
  ...
  if (m_smtkOp.lock()->typeName() == "smtk::session::polygon::CreateEdge")
  {
...
smtk::operation::Operation::Result vtkPolygonArcOperation::Operate()
{
  ...
  bool isTweak = m_smtkOp.lock()->typeName() == "smtk::session::polygon::TweakEdge";
