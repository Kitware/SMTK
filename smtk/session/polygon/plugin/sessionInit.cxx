...
typedef smtk::extension::paraview::PluginClient<smtk::session::polygon::Registrar,
...
static std::shared_ptr<PolygonPluginClient> polygon_client =
  std::dynamic_pointer_cast<PolygonPluginClient>(PolygonPluginClient::create());
