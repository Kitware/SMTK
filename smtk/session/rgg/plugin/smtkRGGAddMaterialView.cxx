...
#include "smtk/session/rgg/plugin/ui_smtkRGGAddMaterialParameters.h"
...
void smtkRGGAddMaterialView::requestOperation(const smtk::operation::OperationPtr& op)
{
  if (!op || !op->parameters())
  {
    return;
...
void smtkRGGAddMaterialView::cancelOperation(const smtk::operation::OperationPtr& op)
{
