...
//=========================================================================
#ifndef __smtk_session_rgg_Resource_h
#define __smtk_session_rgg_Resource_h
...
class SMTKRGGSESSION_EXPORT Resource
  : public smtk::resource::DerivedFrom<Resource, smtk::model::Resource>
{
public:
  smtkTypeMacro(smtk::session::rgg::Resource);
...
#endif // __smtk_session_rgg_Resource_h
