...
#include "smtk/session/cgm/BooleanUnion_xml.h"
...
smtkImplementsModelOperation(SMTKCGMSESSION_EXPORT, smtk::session::cgm::BooleanUnion,
  cgm_boolean_union, "union", BooleanUnion_xml, smtk::session::cgm::Session);
