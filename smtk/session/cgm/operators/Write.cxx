...
#include "smtk/session/cgm/Write_xml.h"
...
smtkImplementsModelOperation(SMTKCGMSESSION_EXPORT, smtk::session::cgm::Write, cgm_write, "write",
  Write_xml, smtk::session::cgm::Session);
