...
#include "smtk/session/cgm/CreateBrick_xml.h"
...
smtkImplementsModelOperation(SMTKCGMSESSION_EXPORT, smtk::session::cgm::CreateBrick,
  cgm_create_brick, "create brick", CreateBrick_xml, smtk::session::cgm::Session);
