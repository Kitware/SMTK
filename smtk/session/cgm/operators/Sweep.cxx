...
#include "smtk/session/cgm/Sweep_xml.h"
...
smtkImplementsModelOperation(SMTKCGMSESSION_EXPORT, smtk::session::cgm::Sweep, cgm_sweep, "sweep",
  Sweep_xml, smtk::session::cgm::Session);
