...
#include "smtk/session/cgm/Rotate_xml.h"
...
smtkImplementsModelOperation(SMTKCGMSESSION_EXPORT, smtk::session::cgm::Rotate, cgm_rotate,
  "rotate", Rotate_xml, smtk::session::cgm::Session);
