...
#include "smtk/session/cgm/BooleanSubtraction_xml.h"
...
smtkImplementsModelOperation(SMTKCGMSESSION_EXPORT, smtk::session::cgm::BooleanSubtraction,
  cgm_boolean_subtraction, "subtraction", BooleanSubtraction_xml, smtk::session::cgm::Session);
