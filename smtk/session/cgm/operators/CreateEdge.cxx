...
#include "smtk/session/cgm/CreateEdge_xml.h"
...
smtkImplementsModelOperation(SMTKCGMSESSION_EXPORT, smtk::session::cgm::CreateEdge, cgm_create_edge,
  "create edge", CreateEdge_xml, smtk::session::cgm::Session);
