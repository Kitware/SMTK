...
#include "smtk/session/cgm/RemoveModel_xml.h"
...
smtkImplementsModelOperation(SMTKCGMSESSION_EXPORT, smtk::session::cgm::RemoveModel,
  cgm_remove_model, "remove model", RemoveModel_xml, smtk::session::cgm::Session);
