...
#include "smtk/session/cgm/CreateFace_xml.h"
...
smtkImplementsModelOperation(SMTKCGMSESSION_EXPORT, smtk::session::cgm::CreateFace, cgm_create_face,
  "create face", CreateFace_xml, smtk::session::cgm::Session);
