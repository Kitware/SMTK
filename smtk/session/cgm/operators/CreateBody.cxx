...
#include "smtk/session/cgm/CreateBody_xml.h"
...
smtkImplementsModelOperation(SMTKCGMSESSION_EXPORT, smtk::session::cgm::CreateBody, cgm_create_body,
  "create body", CreateBody_xml, smtk::session::cgm::Session);
