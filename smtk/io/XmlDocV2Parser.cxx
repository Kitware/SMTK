...
//----------------------------------------------------------------------------
void XmlDocV2Parser::process(xml_node &amnode)
{
...
//----------------------------------------------------------------------------
void XmlDocV2Parser::processAttributeInformation(xml_node &root)
{
...
//----------------------------------------------------------------------------
void XmlDocV2Parser::processItemDef(xml_node &node,
                                    smtk::attribute::ItemDefinitionPtr idef)
{
  xml_attribute xatt;
...
//----------------------------------------------------------------------------
void XmlDocV2Parser::processDoubleDef(pugi::xml_node &node,
...
//----------------------------------------------------------------------------
void XmlDocV2Parser::processIntDef(pugi::xml_node &node,
...
//----------------------------------------------------------------------------
void XmlDocV2Parser::processStringDef(pugi::xml_node &node,
...
//----------------------------------------------------------------------------
void XmlDocV2Parser::processModelEntityDef(pugi::xml_node &node,
...
//----------------------------------------------------------------------------
void XmlDocV2Parser::processValueDef(pugi::xml_node &node,
...
//----------------------------------------------------------------------------
void XmlDocV2Parser::processRefDef(pugi::xml_node &node,
...
//----------------------------------------------------------------------------
void XmlDocV2Parser::processGroupDef(pugi::xml_node &node,
...
//----------------------------------------------------------------------------
void XmlDocV2Parser::processAttribute(xml_node &attNode)
{
...
//----------------------------------------------------------------------------
void XmlDocV2Parser::processItem(xml_node &node,
...
//----------------------------------------------------------------------------
void XmlDocV2Parser::processValueItem(pugi::xml_node &node,
...
//----------------------------------------------------------------------------
void XmlDocV2Parser::processRefItem(pugi::xml_node &node,
...
//----------------------------------------------------------------------------
void XmlDocV2Parser::processDoubleItem(pugi::xml_node &node,
...
//----------------------------------------------------------------------------
void XmlDocV2Parser::processGroupItem(pugi::xml_node &node,
...
//----------------------------------------------------------------------------
bool XmlDocV2Parser::getColor(xml_node &node, double color[4],
...
//----------------------------------------------------------------------------
void XmlDocV2Parser::processAttributeView(xml_node &node,
...
//----------------------------------------------------------------------------
void XmlDocV2Parser::processInstancedView(xml_node &node,
...
//----------------------------------------------------------------------------
void XmlDocV2Parser::processModelEntityView(xml_node &node,
...
//----------------------------------------------------------------------------
void XmlDocV2Parser::processSimpleExpressionView(xml_node &node,
...
//----------------------------------------------------------------------------
void XmlDocV2Parser::processGroupView(xml_node &node,
...
//----------------------------------------------------------------------------
void XmlDocV2Parser::processBasicView(xml_node &node,
                                      smtk::view::BasePtr v)
{
  xml_attribute xatt;
...
//----------------------------------------------------------------------------
int XmlDocV2Parser::decodeColorInfo(const std::string &s, double *color)
{
...
//----------------------------------------------------------------------------
smtk::model::BitFlags
XmlDocV2Parser::decodeModelEntityMask(const std::string &s)
{
