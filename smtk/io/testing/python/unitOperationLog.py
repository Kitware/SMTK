...
class LogOperationNames(smtk.io.OperatorLog):
    ...
    """Inherit the pure virtual C++ OperationLog class.
    ...
    def __init__(self, mgr):
        ...
        super(LogOperationNames, self).__init__(mgr)
    ...
    def recordResult(self, evt, op, res):
        ...
        outcome = smtk.model.OperationOutcome(
...
class TestOperationLog(smtk.testing.TestCase):
    ...
    def testSimpleLogging(self):
        ...
        recorder = LogOperationNames(self.mgr)
        ...
        self.assertEqual(
            ...
            [
                ['create sphere',
                    smtk.model.OperationOutcome.OPERATION_SUCCEEDED],
                ['create sphere',
                    smtk.model.OperationOutcome.OPERATION_SUCCEEDED],
                ['union', smtk.model.OperationOutcome.OPERATION_SUCCEEDED],
                ['create cylinder',
                    smtk.model.OperationOutcome.OPERATION_SUCCEEDED]
            ])
