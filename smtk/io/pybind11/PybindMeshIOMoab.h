...
PySharedPtrClass< smtk::io::mesh::MeshIOMoab > pybind11_init_smtk_io_mesh_MeshIOMoab(py::module &m, PySharedPtrClass< smtk::io::mesh::MeshIO >& parent)
{
  ...
  instance
    ...
    .def("importMesh", (smtk::mesh::CollectionPtr (smtk::io::mesh::MeshIOMoab::*)(::std::string const &, const ::smtk::mesh::InterfacePtr &, ::std::string const &) const) &smtk::io::mesh::MeshIOMoab::importMesh, py::arg("filePath"), py::arg("interface"), py::arg("arg2"))
    ...
    .def("read", (smtk::mesh::CollectionPtr (smtk::io::mesh::MeshIOMoab::*)(::std::string const &, const ::smtk::mesh::InterfacePtr &, ::smtk::io::mesh::Subset) const) &smtk::io::mesh::MeshIOMoab::read, py::arg("filePath"), py::arg("interface"), py::arg("s"))
