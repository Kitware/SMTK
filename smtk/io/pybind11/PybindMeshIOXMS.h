...
PySharedPtrClass< smtk::io::mesh::MeshIOXMS > pybind11_init_smtk_io_mesh_MeshIOXMS(py::module &m, PySharedPtrClass< smtk::io::mesh::MeshIO >& parent)
{
  ...
  instance
    ...
    .def("exportMesh", (bool (smtk::io::mesh::MeshIOXMS::*)(::std::ostream &, ::smtk::mesh::CollectionPtr, ::smtk::model::ResourcePtr, ::std::string const &, ::smtk::mesh::DimensionType) const) &smtk::io::mesh::MeshIOXMS::exportMesh, py::arg("stream"), py::arg("collection"), py::arg("resource"), py::arg("modelPropertyName"), py::arg("dim"))
    .def("exportMesh", (bool (smtk::io::mesh::MeshIOXMS::*)(::std::string const &, ::smtk::mesh::CollectionPtr, ::smtk::model::ResourcePtr, ::std::string const &, ::smtk::mesh::DimensionType) const) &smtk::io::mesh::MeshIOXMS::exportMesh, py::arg("filePath"), py::arg("collection"), py::arg("resource"), py::arg("modelPropertyName"), py::arg("dim"))
    .def("exportMesh", (bool (smtk::io::mesh::MeshIOXMS::*)(::std::string const &, ::smtk::mesh::CollectionPtr, ::smtk::model::ResourcePtr, ::std::string const &) const) &smtk::io::mesh::MeshIOXMS::exportMesh, py::arg("filePath"), py::arg("collection"), py::arg("resource"), py::arg("modelPropertyName"))
    ;
  return instance;
}
