...
#ifndef smtk_project_old_Project_h
#define smtk_project_old_Project_h
...
public:
  smtkTypedefs(smtk::project::old::Project);
...
private:
  Project();
}; // class smtk::project::old::Project
...
#endif // smtk_project_old_Project_h
