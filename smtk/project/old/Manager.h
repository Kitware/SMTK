...
#ifndef smtk_project_old_Manager_h
#define smtk_project_old_Manager_h
...
{
public:
  smtkTypedefs(smtk::project::old::Manager);
  static smtk::project::old::ManagerPtr create(
...
private:
  ...
  /// Current project
  smtk::project::old::ProjectPtr m_project;
...
#endif // smtk_project_old_Manager_h
