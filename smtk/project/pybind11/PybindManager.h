...
PySharedPtrClass< smtk::project::Manager > pybind11_init_smtk_project_Manager(py::module &m)
{
  ...
  instance
    ...
    .def("create", (smtk::project::ProjectPtr (smtk::project::Manager::*)(::std::string const &)) &smtk::project::Manager::create, py::arg("arg0"))
    .def("create", (smtk::project::ProjectPtr (smtk::project::Manager::*)(::smtk::project::Project::Index const &)) &smtk::project::Manager::create, py::arg("arg0"))
    .def("create", (smtk::project::ProjectPtr (smtk::project::Manager::*)(::std::string const &, ::smtk::common::UUID const &)) &smtk::project::Manager::create, py::arg("arg0"), py::arg("arg1"))
    .def("create", (smtk::project::ProjectPtr (smtk::project::Manager::*)(::smtk::project::Project::Index const &, ::smtk::common::UUID const &)) &smtk::project::Manager::create, py::arg("arg0"), py::arg("arg1"))
