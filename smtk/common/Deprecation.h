...
#if SMTK_DEPRECATION_LEVEL >= SMTK_VERSION_CHECK(21, 6)
#define SMTK_DEPRECATED_IN_21_06(reason) SMTK_DEPRECATION(SMTK_DEPRECATION_REASON(21, 6, reason))
#else
#define SMTK_DEPRECATED_IN_21_06(reason)
#endif
