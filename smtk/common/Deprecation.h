...
#if SMTK_DEPRECATION_LEVEL >= SMTK_VERSION_CHECK(22, 03)
#define SMTK_DEPRECATED_IN_22_03(reason) SMTK_DEPRECATION(SMTK_DEPRECATION_REASON(22, 03, reason))
#else
#define SMTK_DEPRECATED_IN_22_03(reason)
#endif
