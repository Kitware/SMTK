...
#define SMTK_DEPRECATED_IN_22_10(reason) SMTK_DEPRECATION(SMTK_DEPRECATION_REASON(22, 11, reason))
#else
#define SMTK_DEPRECATED_IN_22_10(reason)
#endif

#if SMTK_DEPRECATION_LEVEL >= SMTK_VERSION_CHECK(22, 10)
#define SMTK_DEPRECATED_IN_22_10(reason) SMTK_DEPRECATION(SMTK_DEPRECATION_REASON(22, 10, reason))
#else
#define SMTK_DEPRECATED_IN_22_10(reason)
#endif
