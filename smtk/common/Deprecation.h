...
#if SMTK_DEPRECATION_LEVEL >= SMTK_VERSION_CHECK(25, 06, 99)
#define SMTK_DEPRECATED_IN_NEXT(reason) SMTK_DEPRECATION(SMTK_DEPRECATION_REASON(25, NEXT, reason))
#else
#define SMTK_DEPRECATED_IN_NEXT(reason)
#endif

#if SMTK_DEPRECATION_LEVEL >= SMTK_VERSION_CHECK(25, 05, 99)
#define SMTK_DEPRECATED_IN_25_06(reason) SMTK_DEPRECATION(SMTK_DEPRECATION_REASON(25, 06, reason))
#else
#define SMTK_DEPRECATED_IN_25_06(reason)
#endif

#if SMTK_DEPRECATION_LEVEL >= SMTK_VERSION_CHECK(24, 10, 99)
#define SMTK_DEPRECATED_IN_24_11(reason) SMTK_DEPRECATION(SMTK_DEPRECATION_REASON(24, 11, reason))
#else
#define SMTK_DEPRECATED_IN_24_11(reason)
#endif
