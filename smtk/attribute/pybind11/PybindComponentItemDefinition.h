...
py::class_< smtk::attribute::ComponentItemDefinition, smtk::attribute::ItemDefinition > pybind11_init_smtk_attribute_ComponentItemDefinition(py::module &m)
{
  ...
  instance
    ...
    .def("setAcceptsEntries", (bool (smtk::attribute::ComponentItemDefinition::*)(::std::string const &, ::std::string const &, bool)) &smtk::attribute::ComponentItemDefinition::setAcceptsEntries, py::arg("uniqueName"), py::arg("queryString"), py::arg("accept"))
