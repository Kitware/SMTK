...
py::class_< smtk::attribute::ComponentItemDefinition, smtk::attribute::ItemDefinition > pybind11_init_smtk_attribute_ComponentItemDefinition(py::module &m)
{
  ...
  instance
    ...
    .def("setAcceptsResourceComponents", (bool (smtk::attribute::ComponentItemDefinition::*)(::std::string const &, ::std::string const &, bool)) &smtk::attribute::ComponentItemDefinition::setAcceptsResourceComponents, py::arg("uniqueName"), py::arg("queryString"), py::arg("accept"))
