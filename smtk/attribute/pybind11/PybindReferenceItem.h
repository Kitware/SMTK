...
PySharedPtrClass< smtk::attribute::ReferenceItem, smtk::attribute::Item > pybind11_init_smtk_attribute_ReferenceItem(py::module &m)
{
  ...
  instance
    ...
    .def("find", (ptrdiff_t (smtk::attribute::ReferenceItem::*)(::smtk::resource::PersistentObjectPtr) const) &smtk::attribute::ReferenceItem::find, py::arg("component"))
    .def("has", (bool (smtk::attribute::ReferenceItem::*)(::smtk::common::UUID const &) const) &smtk::attribute::ReferenceItem::has, py::arg("compId"))
    .def("has", (bool (smtk::attribute::ReferenceItem::*)(::smtk::resource::PersistentObjectPtr) const) &smtk::attribute::ReferenceItem::has, py::arg("obj"))
    ...
    .def("setObjectValue", (bool (smtk::attribute::ReferenceItem::*)(::smtk::resource::PersistentObjectPtr)) &smtk::attribute::ReferenceItem::setObjectValue, py::arg("val"))
    .def("setObjectValue", (bool (smtk::attribute::ReferenceItem::*)(::size_t, ::smtk::resource::PersistentObjectPtr)) &smtk::attribute::ReferenceItem::setObjectValue, py::arg("i"), py::arg("val"))
