...
PySharedPtrClass< smtk::attribute::ResourceItem, smtk::attribute::Item > pybind11_init_smtk_attribute_ResourceItem(py::module &m)
{
  ...
  instance
    ...
    .def("find", (ptrdiff_t (smtk::attribute::ResourceItem::*)(::smtk::resource::PersistentObjectPtr) const) &smtk::attribute::ResourceItem::find, py::arg("resource"))
    .def("has", (bool (smtk::attribute::ResourceItem::*)(::smtk::common::UUID const &) const) &smtk::attribute::ResourceItem::has, py::arg("rsrcId"))
    .def("has", (bool (smtk::attribute::ResourceItem::*)(::smtk::resource::PersistentObjectPtr) const) &smtk::attribute::ResourceItem::has, py::arg("rsrc"))
