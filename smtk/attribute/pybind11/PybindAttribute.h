...
PySharedPtrClass< smtk::attribute::Attribute > pybind11_init_smtk_attribute_Attribute(py::module &m)
{
  ...
  instance
    ...
    .def("associatedComponents", (smtk::attribute::ComponentItemPtr (smtk::attribute::Attribute::*)()) &smtk::attribute::Attribute::associatedComponents)
    ...
    .def("isComponentAssociated", (bool (smtk::attribute::Attribute::*)(::smtk::common::UUID const &) const) &smtk::attribute::Attribute::isComponentAssociated, py::arg("uid"))
    .def("isComponentAssociated", (bool (smtk::attribute::Attribute::*)(::smtk::resource::ComponentPtr const &) const) &smtk::attribute::Attribute::isComponentAssociated, py::arg("componentPtr"))
