...
inline PySharedPtrClass< smtk::attribute::Item > pybind11_init_smtk_attribute_Item(py::module &m)
{
  ...
  instance
    ...
    .def("customIsValid", &smtk::attribute::Item::customIsRelevant)
    .def("setCustomIsValid", &smtk::attribute::Item::setCustomIsRelevant, py::arg("customIsValidFunc"))
    ...
    .def("defaultIsValid", (bool (smtk::attribute::Item::*)(bool) const) &smtk::attribute::Item::isValid, py::arg("useActiveCategories") = true)
    .def("defaultIsValid", (bool (smtk::attribute::Item::*)(std::set<std::string> const &) const) &smtk::attribute::Item::isValid, py::arg("categories"))
