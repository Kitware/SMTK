...
bool ModelEntityItemDefinition::isValueValid(const smtk::model::EntityRef& c) const
{
  ...
  if (m_membershipMask == smtk::model::ANY_ENTITY)
  {
  ...
  if (((m_membershipMask & smtk::model::ENTITY_MASK) &&
        !(itemType & m_membershipMask & smtk::model::ENTITY_MASK) &&
        (itemType & smtk::model::ENTITY_MASK) != smtk::model::GROUP_ENTITY) ||
    ((m_membershipMask & smtk::model::ANY_DIMENSION) &&
        !(itemType & m_membershipMask & smtk::model::ANY_DIMENSION)) ||
    ((itemType & smtk::model::GROUP_ENTITY) &&
        (m_membershipMask & smtk::model::GROUP_CONSTRAINT_MASK) &&
        !(itemType & m_membershipMask & smtk::model::GROUP_CONSTRAINT_MASK)))
    return false;
  if (itemType != this->membershipMask() && itemType & smtk::model::GROUP_ENTITY &&
    ...
    m_membershipMask != smtk::model::GROUP_ENTITY)
  {
    ...
    smtk::model::BitFlags typeMask = m_membershipMask;
