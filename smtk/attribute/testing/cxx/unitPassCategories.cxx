...
void setupAttributeResource(attribute::ResourcePtr& attRes)
{
  ...
  sItemDef2->localCategories().setInclusionMode(Categories::Set::CombinationMode::All);
  ...
  es.setInclusionMode(Categories::Set::CombinationMode::All);
  sItemDef3->setEnumCategories("e1", es);
  es.reset();
  es.insertInclusion("c");
  es.insertInclusion("d");
  es.setInclusionMode(Categories::Set::CombinationMode::Any);
