...
int unitEvaluatorManager(int /*argc*/, char** const /*argv*/)
{
  ...
  smtkTest(evaluatorManager->registerEvaluator<FooEvaluator>("FooEvaluator"),
  ...
  smtkTest(managedAttRes->evaluatorFactory().addDefinitionForEvaluator(
    ...
    smtkTest(evaluatorManager->unregisterEvaluator<FooEvaluator>(),
