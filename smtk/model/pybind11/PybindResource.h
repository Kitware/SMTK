...
PySharedPtrClass< smtk::model::Resource, smtk::resource::Resource > pybind11_init_smtk_model_Resource(py::module &m)
{
  ...
  instance
    ...
    .def("createSession", (smtk::model::SessionRef (smtk::model::Resource::*)(::std::string const &)) &smtk::model::Resource::createSession, py::arg("sname"))
    .def("createSession", (smtk::model::SessionRef (smtk::model::Resource::*)(::std::string const &, ::smtk::model::SessionRef const &)) &smtk::model::Resource::createSession, py::arg("sname"), py::arg("sessionIdSpecifier"))
    .def_static("createSessionOfType", &smtk::model::Resource::createSessionOfType, py::arg("sname"))
    ...
    .def("floatProperties", (smtk::model::UUIDsToFloatData & (smtk::model::Resource::*)()) &smtk::model::Resource::floatProperties)
    .def("floatProperties", (smtk::model::UUIDsToFloatData const & (smtk::model::Resource::*)() const) &smtk::model::Resource::floatProperties)
    .def("floatPropertiesForEntity", (smtk::model::UUIDWithFloatProperties const (smtk::model::Resource::*)(::smtk::common::UUID const &) const) &smtk::model::Resource::floatPropertiesForEntity, py::arg("entity"))
    .def("floatPropertiesForEntity", (smtk::model::UUIDWithFloatProperties (smtk::model::Resource::*)(::smtk::common::UUID const &)) &smtk::model::Resource::floatPropertiesForEntity, py::arg("entity"))
    ...
    .def("integerProperties", (smtk::model::UUIDsToIntegerData & (smtk::model::Resource::*)()) &smtk::model::Resource::integerProperties)
    .def("integerProperties", (smtk::model::UUIDsToIntegerData const & (smtk::model::Resource::*)() const) &smtk::model::Resource::integerProperties)
    .def("integerPropertiesForEntity", (smtk::model::UUIDWithIntegerProperties const (smtk::model::Resource::*)(::smtk::common::UUID const &) const) &smtk::model::Resource::integerPropertiesForEntity, py::arg("entity"))
    .def("integerPropertiesForEntity", (smtk::model::UUIDWithIntegerProperties (smtk::model::Resource::*)(::smtk::common::UUID const &)) &smtk::model::Resource::integerPropertiesForEntity, py::arg("entity"))
    ...
    .def_static("sessionFileTypes", &smtk::model::Resource::sessionFileTypes, py::arg("sname"), py::arg("engine") = std::string())
    .def("sessionOwningEntity", &smtk::model::Resource::sessionOwningEntity, py::arg("uid"))
    .def_static("sessionTypeNames", &smtk::model::Resource::sessionTypeNames)
    ...
    .def("stringProperties", (smtk::model::UUIDsToStringData & (smtk::model::Resource::*)()) &smtk::model::Resource::stringProperties)
    .def("stringProperties", (smtk::model::UUIDsToStringData const & (smtk::model::Resource::*)() const) &smtk::model::Resource::stringProperties)
    .def("stringPropertiesForEntity", (smtk::model::UUIDWithStringProperties const (smtk::model::Resource::*)(::smtk::common::UUID const &) const) &smtk::model::Resource::stringPropertiesForEntity, py::arg("entity"))
    .def("stringPropertiesForEntity", (smtk::model::UUIDWithStringProperties (smtk::model::Resource::*)(::smtk::common::UUID const &)) &smtk::model::Resource::stringPropertiesForEntity, py::arg("entity"))
