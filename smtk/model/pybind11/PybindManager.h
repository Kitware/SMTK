...
PySharedPtrClass< smtk::model::Manager > pybind11_init_smtk_model_Manager(py::module &m)
{
  ...
  instance
    ...
    .def("setTessellation", &smtk::model::Manager::setTessellationAndBoundingBox, py::arg("cellId"), py::arg("geom"), py::arg("analysis") = 0, py::arg("gen") = nullptr)
    .def("setTessellationAndBoundingBox", &smtk::model::Manager::setTessellationAndBoundingBox, py::arg("cellId"), py::arg("geom"), py::arg("analysis") = 0, py::arg("gen") = nullptr)
