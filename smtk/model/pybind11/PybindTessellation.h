...
py::class_< smtk::model::Tessellation > pybind11_init_smtk_model_Tessellation(py::module &m)
{
  ...
  instance
    ...
    .def("addCoords", (int (smtk::model::Tessellation::*)(const double *)) &smtk::model::Tessellation::addCoords, py::arg("a"))
    ...
    .def("addPoint", (smtk::model::Tessellation & (smtk::model::Tessellation::*)(const double *)) &smtk::model::Tessellation::addPoint, py::arg("a"))
    .def("addLine", (smtk::model::Tessellation & (smtk::model::Tessellation::*)(const double *, const double *)) &smtk::model::Tessellation::addLine, py::arg("a"), py::arg("b"))
    .def("addTriangle", (smtk::model::Tessellation & (smtk::model::Tessellation::*)(const double *, const double *, const double *)) &smtk::model::Tessellation::addTriangle, py::arg("a"), py::arg("b"), py::arg("c"))
    .def("addQuad", (smtk::model::Tessellation & (smtk::model::Tessellation::*)(const double *, const double *, const double *, const double *)) &smtk::model::Tessellation::addQuad, py::arg("a"), py::arg("b"), py::arg("c"), py::arg("d"))
