...
Delete::Result Delete::operateInternal()
{
  ...
  // TODO: Handle associations properly?
  resource->deleteEntities(faces, m_modified, m_expunged, m_debugLevel > 0);
  resource->deleteEntities(edges, m_modified, m_expunged, m_debugLevel > 0);
  resource->deleteEntities(verts, m_modified, m_expunged, m_debugLevel > 0);
  resource->deleteEntities(other, m_modified, m_expunged, m_debugLevel > 0);
