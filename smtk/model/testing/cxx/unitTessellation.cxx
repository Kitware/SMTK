...
{
  Tessellation tess;
  double coords[] = { 0., 0., 0., 2., 0., 0., 2., 2., 0., 0., 2., 0., 1., 3., 0., 0., 4., 0., 1.,
    1., 1. };
  ...
  int cellConn1[] = { // INVALID vertex (not enough entries)
    TESS_VERTEX | TESS_FACE_MATERIAL | TESS_FACE_VERTEX_NORMAL, 0
  };
  ...
  int cellConn2[] = {
    // VALID vertex with "don't care" material ID of 100 and "don't care" normal ID
    TESS_VERTEX | TESS_FACE_MATERIAL | TESS_FACE_VERTEX_NORMAL, 0, 100, 0
  };
  ...
  int cellConn3[] = { // INVALID polyvertex (missing normal ID entries)
    TESS_POLYVERTEX | TESS_FACE_VERTEX_NORMAL, 3, 0, 1, 2
  };
  ...
  int cellConn7[] = { // VALID polyline
    TESS_POLYLINE | TESS_FACE_UV | TESS_FACE_MATERIAL | TESS_FACE_VERTEX_NORMAL |
  ...
  int cellConn9[] = { // VALID triangle strip
    TESS_TRIANGLE_STRIP, 5, 0, 1, 3, 2, 4
  };
