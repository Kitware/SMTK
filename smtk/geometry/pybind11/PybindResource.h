...
PySharedPtrClass< smtk::geometry::Resource, smtk::resource::DerivedFrom<smtk::geometry::Resource, smtk::resource::Resource> > pybind11_init_smtk_geometry_Resource(py::module &m)
{
