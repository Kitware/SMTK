...
void qtGroupItem::createWidget()
{
  ...
  // Instantiate a layout for the widget, but do *not* assign to a variable,
  // because that would cause a compiler warning, since the layour is not
  // explicitly referenced anywhere else.
