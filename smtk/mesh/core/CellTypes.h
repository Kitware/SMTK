...
#ifndef __smtk_mesh_core_CellTypes_h
#define __smtk_mesh_core_CellTypes_h
...
struct CellVertex
{
  static const CellType CellEnum = Vertex;
};
struct CellLine
{
  static const CellType CellEnum = Line;
};
struct CellTriangle
{
  static const CellType CellEnum = Triangle;
};
struct CellQuad
{
  static const CellType CellEnum = Quad;
};
struct CellPolygon
{
  static const CellType CellEnum = Polygon;
};
struct CellTetrahedron
{
  static const CellType CellEnum = Tetrahedron;
};
struct CellPyramid
{
  static const CellType CellEnum = Pyramid;
};
struct CellWedge
{
  static const CellType CellEnum = Wedge;
};
struct CellHexahedron
{
  static const CellType CellEnum = Hexahedron;
};

} // namespace mesh
} // namespace smtk

#endif //__smtk_mesh_core_CellTypes_h
