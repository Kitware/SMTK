...
namespace json
{
void to_json(json& j, const std::vector<MeshInfo>& meshInfos)
{
...
void from_json(const json& j, std::vector<MeshInfo>& meshInfos)
{
  ...
  for (nlohmann::json::iterator mesh_json_it = meshes_json.begin();
       mesh_json_it != meshes_json.end(); ++mesh_json_it, ++meshIdIdx)
  {
    ...
    smtk::mesh::json::MeshInfo meshInfo(meshIds[meshIdIdx], id, cells, points, types);
