...
PySharedPtrClass< smtk::mesh::Interface > pybind11_init_smtk_mesh_Interface(py::module &m)
{
  ...
  instance
    ...
    .def_property("rootAssociation", &smtk::mesh::Interface::rootAssociation, &smtk::mesh::Interface::setRootAssociation)
...
PySharedPtrClass< smtk::mesh::Allocator > pybind11_init_smtk_mesh_Allocator(py::module &m)
{
  ...
  instance
    ...
    // .def("allocateCells", (bool (smtk::mesh::Allocator::*)(smtk::mesh::CellType, std::size_t, int, smtk::mesh::HandleRange&, smtk::mesh::Handle*&)) &smtk::mesh::Allocator::allocateCells, py::arg("cellType"), py::arg("numCellsToAlloc"), py::arg("numVertsPerCell"), py::arg("createdCellIds"), py::arg("connectivityArray"))
...
PySharedPtrClass< smtk::mesh::ConnectivityStorage > pybind11_init_smtk_mesh_ConnectivityStorage(py::module &m)
{
  ...
  instance
    ...
    ;
  PySharedPtrClass< smtk::mesh::ConnectivityStorage::IterationState >(instance, "IterationState")
    .def(py::init<>())
...
PySharedPtrClass< smtk::mesh::PointLocatorImpl > pybind11_init_smtk_mesh_PointLocatorImpl(py::module &m)
{
  ...
  instance
    ...
    ;
  PySharedPtrClass< smtk::mesh::PointLocatorImpl::Results >(instance, "Results")
    .def(py::init<>())
