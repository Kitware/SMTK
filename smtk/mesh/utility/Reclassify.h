...
#ifndef __smtk_mesh_utility_Reclassify_h
#define __smtk_mesh_utility_Reclassify_h
...
SMTKCORE_EXPORT
bool split(smtk::mesh::ResourcePtr, smtk::model::Edge orignalEdge, smtk::model::Edge newEdge,
...
SMTKCORE_EXPORT
bool merge(smtk::mesh::ResourcePtr, smtk::model::Vertex toRemoveVert,
...
SMTKCORE_EXPORT
bool make_disjoint(smtk::mesh::ResourcePtr, const smtk::mesh::MeshSet& a, smtk::mesh::MeshSet& b,
...
//meshset
SMTKCORE_EXPORT
bool fuse(smtk::mesh::ResourcePtr, smtk::mesh::MeshSet& toRemove, smtk::mesh::MeshSet& toAddTo,
