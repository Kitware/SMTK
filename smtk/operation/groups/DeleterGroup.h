...
#ifndef smtk_operation_DeleterGroup_h
#define smtk_operation_DeleterGroup_h
...
/**\brief A group that holds operations which can delete things.
  *
  * All operations added to this group must allow associations to
  * things that they can delete.
  *
  * It is best if they (1) have defaults for any parameters and if
  * they have extensible associations
  */
class SMTKCORE_EXPORT DeleterGroup : protected Group
{
public:
  static constexpr const char* const type_name = "deleter";

  DeleterGroup(std::shared_ptr<smtk::operation::Manager> manager)
