...
PySharedPtrClass< smtk::operation::XMLOperation, smtk::operation::Operation > pybind11_init_smtk_operation_XMLOperation(py::module &m)
{
  ...
  instance
    ...
    .def("classname", &smtk::operation::XMLOperation::classname)
