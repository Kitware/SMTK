...
PySharedPtrClass< smtk::operation::ReadResource, smtk::operation::XMLOperation > pybind11_init_smtk_operation_ReadResource(py::module &m)
{
  ...
  instance
    ...
    .def("classname", &smtk::operation::ReadResource::classname)
