...
PySharedPtrClass< smtk::bridge::polygon::SplitEdge > pybind11_init_smtk_bridge_polygon_SplitEdge(py::module &m, PySharedPtrClass< smtk::bridge::polygon::Operation, smtk::operation::XMLOperation >& parent)
{
