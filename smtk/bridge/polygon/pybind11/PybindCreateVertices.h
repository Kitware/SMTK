...
PySharedPtrClass< smtk::bridge::polygon::CreateVertices> pybind11_init_smtk_bridge_polygon_CreateVertices(py::module &m, PySharedPtrClass< smtk::bridge::polygon::Operator, smtk::operation::XMLOperator >& parent)
{
