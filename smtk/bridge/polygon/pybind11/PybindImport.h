...
PySharedPtrClass< smtk::bridge::polygon::Import > pybind11_init_smtk_bridge_polygon_Import(py::module &m, PySharedPtrClass< smtk::bridge::polygon::Operation, smtk::operation::XMLOperation >& parent)
{
