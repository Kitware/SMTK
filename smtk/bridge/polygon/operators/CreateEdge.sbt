...
<SMTK_AttributeSystem Version="3">
  <Definitions>
    ...
    <AttDef Type="create edge" Label="Edge - Create Interactively" BaseType="operation">
  ...
  <Views>
     <!-- The customized view "Type" needs to be the the same as in plugin macro
      ...
      -->
    <View Type="smtkPolygonEdgeView" Title="Create Polygon Edge" FilterByCategory="false" UseSelectionManager="true">
      <AttributeTypes>
