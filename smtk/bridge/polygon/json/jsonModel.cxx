...
void to_json(json& j, const smtk::bridge::polygon::internal::pmodel::Ptr& pmodel)
{
  j["type"] = "model";
...
void from_json(const json& j, smtk::bridge::polygon::internal::pmodel::Ptr& pmodel)
{
  try
  {
    ...
    pmodel = smtk::bridge::polygon::internal::pmodel::create();
