...
namespace internal
{
void to_json(json& j, const smtk::bridge::polygon::internal::vertex::Ptr& vertex)
{
  j["type"] = "vertex";
  ...
  smtk::bridge::polygon::internal::Coord c = vertex->point().x();
  ptdata[0] = c & 0xffff;
  c >>= 16;
  ptdata[1] = c & 0xffff;
  c >>= 16;
  ...
  smtk::bridge::polygon::internal::vertex::incident_edges::const_iterator ieit;
...
void from_json(const json& j, smtk::bridge::polygon::internal::vertex::Ptr& vertex)
{
  vertex = smtk::bridge::polygon::internal::vertex::create();
  ...
  try
  {
    ...
    if (np > 0)
    {
      ...
      vertex->point() = smtk::bridge::polygon::internal::Point(xy[0], xy[1]);
    }
  }
  ...
  for (json::const_iterator er = iearr.begin(); er != iearr.end(); ++er)
  {
    bool haveEdge = false;
    bool haveFace = false;
    smtk::bridge::polygon::internal::Id edgeId;
    smtk::bridge::polygon::internal::Id faceId;
    bool edgeOut;
    try
    {
    ...
    vertex->dangerousAppendEdge((haveEdge && haveFace
        ? smtk::bridge::polygon::internal::vertex::incident_edge_data(edgeId, edgeOut, faceId)
        : (haveEdge
              ? smtk::bridge::polygon::internal::vertex::incident_edge_data(edgeId, edgeOut)
              : (haveFace ? smtk::bridge::polygon::internal::vertex::incident_edge_data(faceId)
                          : (smtk::bridge::polygon::internal::vertex::incident_edge_data())))));
  }
}
} // namespace internal
} // namespace polygon
