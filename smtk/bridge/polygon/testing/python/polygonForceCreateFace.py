...
class TestPolygonCreation(smtk.testing.TestCase):
    ...
    def createFaces(self, modelOrEdges, **kwargs):
        ...
        """
        crf = smtk.bridge.polygon.CreateFaces.create()
    ...
    def testCreationFromPoints(self):
        ...
        fop = smtk.bridge.polygon.ForceCreateFace.create()
...
if __name__ == '__main__':
    print(
        'This test has been disabled until smtk::bridge::ForceCreateFace is fixed.\n'
