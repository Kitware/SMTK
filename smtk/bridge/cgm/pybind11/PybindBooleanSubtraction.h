...
PySharedPtrClass< smtk::bridge::cgm::BooleanSubtraction > pybind11_init_smtk_bridge_cgm_BooleanSubtraction(py::module &m, PySharedPtrClass< smtk::bridge::cgm::Operation, smtk::operation::Operation >& parent)
{
