...
PySharedPtrClass< smtk::bridge::cgm::CreateSphere > pybind11_init_smtk_bridge_cgm_CreateSphere(py::module &m, PySharedPtrClass< smtk::bridge::cgm::Operation, smtk::operation::Operation >& parent)
{
