...
PySharedPtrClass< smtk::bridge::cgm::Sweep > pybind11_init_smtk_bridge_cgm_Sweep(py::module &m, PySharedPtrClass< smtk::bridge::cgm::Operation, smtk::operation::Operation >& parent)
{
