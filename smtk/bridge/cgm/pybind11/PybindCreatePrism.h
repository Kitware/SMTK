...
PySharedPtrClass< smtk::bridge::cgm::CreatePrism > pybind11_init_smtk_bridge_cgm_CreatePrism(py::module &m, PySharedPtrClass< smtk::bridge::cgm::Operation, smtk::operation::Operation >& parent)
{
