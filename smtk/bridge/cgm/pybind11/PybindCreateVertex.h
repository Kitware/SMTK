...
PySharedPtrClass< smtk::bridge::cgm::CreateVertex > pybind11_init_smtk_bridge_cgm_CreateVertex(py::module &m, PySharedPtrClass< smtk::bridge::cgm::Operator, smtk::operation::NewOp >& parent)
{
