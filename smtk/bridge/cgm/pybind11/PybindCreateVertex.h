...
PySharedPtrClass< smtk::bridge::cgm::CreateVertex > pybind11_init_smtk_bridge_cgm_CreateVertex(py::module &m, PySharedPtrClass< smtk::bridge::cgm::Operation, smtk::operation::Operation >& parent)
{
