...
PySharedPtrClass< smtk::bridge::cgm::Write > pybind11_init_smtk_bridge_cgm_Write(py::module &m, PySharedPtrClass< smtk::bridge::cgm::Operation, smtk::operation::Operation >& parent)
{
