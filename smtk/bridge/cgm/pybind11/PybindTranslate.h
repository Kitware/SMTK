...
PySharedPtrClass< smtk::bridge::cgm::Translate > pybind11_init_smtk_bridge_cgm_Translate(py::module &m, PySharedPtrClass< smtk::bridge::cgm::Operator, smtk::operation::NewOp >& parent)
{
