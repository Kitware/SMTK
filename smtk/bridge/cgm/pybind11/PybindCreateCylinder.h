...
PySharedPtrClass< smtk::bridge::cgm::CreateCylinder > pybind11_init_smtk_bridge_cgm_CreateCylinder(py::module &m, PySharedPtrClass< smtk::bridge::cgm::Operator, smtk::operation::NewOp >& parent)
{
