...
PySharedPtrClass< smtk::bridge::cgm::RemoveModel > pybind11_init_smtk_bridge_cgm_RemoveModel(py::module &m, PySharedPtrClass< smtk::bridge::cgm::Operation, smtk::operation::Operation >& parent)
{
