...
PySharedPtrClass< smtk::bridge::cgm::Rotate > pybind11_init_smtk_bridge_cgm_Rotate(py::module &m, PySharedPtrClass< smtk::bridge::cgm::Operator, smtk::operation::NewOp >& parent)
{
