...
PySharedPtrClass< smtk::bridge::cgm::Scale > pybind11_init_smtk_bridge_cgm_Scale(py::module &m, PySharedPtrClass< smtk::bridge::cgm::Operator, smtk::operation::NewOp >& parent)
{
