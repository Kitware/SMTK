...
PySharedPtrClass< smtk::bridge::cgm::CreateFace > pybind11_init_smtk_bridge_cgm_CreateFace(py::module &m, PySharedPtrClass< smtk::bridge::cgm::Operator, smtk::operation::NewOp >& parent)
{
