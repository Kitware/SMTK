...
PySharedPtrClass< smtk::bridge::cgm::CreateBody > pybind11_init_smtk_bridge_cgm_CreateBody(py::module &m, PySharedPtrClass< smtk::bridge::cgm::Operator, smtk::operation::NewOp >& parent)
{
