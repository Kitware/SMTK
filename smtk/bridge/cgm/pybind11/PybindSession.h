...
PySharedPtrClass< smtk::bridge::cgm::Session, smtk::model::Session > pybind11_init_smtk_bridge_cgm_Session(py::module &m)
{
  ...
  instance
    ...
    // .def("findOperationConstructor", &smtk::bridge::cgm::Session::findOperationConstructor, py::arg("opName"))
    .def("inheritsOperations", &smtk::bridge::cgm::Session::inheritsOperations)
