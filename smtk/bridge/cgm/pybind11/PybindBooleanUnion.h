...
PySharedPtrClass< smtk::bridge::cgm::BooleanUnion > pybind11_init_smtk_bridge_cgm_BooleanUnion(py::module &m, PySharedPtrClass< smtk::bridge::cgm::Operation, smtk::operation::Operation >& parent)
{
