...
PySharedPtrClass< smtk::bridge::cgm::Reflect > pybind11_init_smtk_bridge_cgm_Reflect(py::module &m, PySharedPtrClass< smtk::bridge::cgm::Operation, smtk::operation::Operation >& parent)
{
