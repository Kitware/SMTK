...
PySharedPtrClass< smtk::bridge::cgm::CreateEdge > pybind11_init_smtk_bridge_cgm_CreateEdge(py::module &m, PySharedPtrClass< smtk::bridge::cgm::Operation, smtk::operation::Operation >& parent)
{
