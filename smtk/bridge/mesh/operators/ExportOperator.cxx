...
#include "smtk/bridge/mesh/ExportOperator_xml.h"
...
smtk::bridge::mesh::ExportOperator::Result ExportOperator::operateInternal()
{
...
const char* ExportOperator::xmlDescription() const
{
  return ExportOperator_xml;
}
