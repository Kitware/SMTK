...
//=========================================================================
#include "smtk/bridge/rgg/plugin/smtkRGGRemoveMaterialView.h"
#include "smtk/bridge/rgg/plugin/ui_smtkRGGRemoveMaterialParameters.h"
...
void smtkRGGRemoveMaterialView::requestOperation(const smtk::model::OperatorPtr& op)
{
...
void smtkRGGRemoveMaterialView::cancelOperation(const smtk::model::OperatorPtr& op)
{
