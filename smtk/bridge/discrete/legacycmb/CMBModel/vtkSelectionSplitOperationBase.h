...
#ifndef __vtkSelectionSplitOperationBase_h
#define __vtkSelectionSplitOperationBase_h
...
class VTKCMBDISCRETEMODEL_EXPORT vtkSelectionSplitOperationBase : public vtkObject
{
public:
...
protected:
  ...
  virtual ~vtkSelectionSplitOperationBase();
