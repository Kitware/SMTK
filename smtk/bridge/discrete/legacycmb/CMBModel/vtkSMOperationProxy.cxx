...
vtkStandardNewMacro(vtkSMOperationProxy);

vtkSMOperationProxy::vtkSMOperationProxy()
{
}
...
void vtkSMOperationProxy::Operate(vtkDiscreteModel* /*ClientModel*/, vtkSMProxy* ModelProxy)
{
...
void vtkSMOperationProxy::Operate(
...
vtkIdType vtkSMOperationProxy::Build(vtkDiscreteModel* /*ClientModel*/, vtkSMProxy* ModelProxy)
{
  this->UpdateVTKObjects();
...
bool vtkSMOperationProxy::Destroy(vtkDiscreteModel* /*ClientModel*/, vtkSMProxy* ModelProxy)
{
  this->UpdateVTKObjects();
...
void vtkSMOperationProxy::PrintSelf(ostream& os, vtkIndent indent)
{
