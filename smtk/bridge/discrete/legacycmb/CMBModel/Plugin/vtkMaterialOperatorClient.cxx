...
bool vtkMaterialOperatorClient::Operate(vtkDiscreteModel* Model, vtkSMProxy* ServerModelProxy)
{
  ...
  vtkSMOperatorProxy* OperatorProxy =
    vtkSMOperatorProxy::SafeDownCast(manager->NewProxy("CMBModelGroup", "MaterialOperator"));
  if (!OperatorProxy)
  {
...
vtkIdType vtkMaterialOperatorClient::Build(vtkDiscreteModel* Model, vtkSMProxy* ServerModelProxy)
{
  vtkSMProxyManager* manager = vtkSMProxyManager::GetProxyManager();
  vtkSMOperatorProxy* OperatorProxy =
    vtkSMOperatorProxy::SafeDownCast(manager->NewProxy("CMBModelGroup", "MaterialOperator"));
  ...
  vtkIdType ServerMaterialId = OperatorProxy->Build(Model, ServerModelProxy);
...
bool vtkMaterialOperatorClient::Destroy(vtkDiscreteModel* Model, vtkSMProxy* ServerModelProxy)
{
