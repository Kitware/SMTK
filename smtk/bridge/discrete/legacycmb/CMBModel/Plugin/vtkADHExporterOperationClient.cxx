...
#include "vtkADHExporterOperationClient.h"
...
vtkStandardNewMacro(vtkADHExporterOperationClient);

vtkADHExporterOperationClient::vtkADHExporterOperationClient()
{
  this->ClientText = 0;
}
...
bool vtkADHExporterOperationClient::Operate(vtkDiscreteModel* model, vtkSMProxy* serverModelProxy)
{
  ...
  vtkSMOperationProxy* operatorProxy =
    vtkSMOperationProxy::SafeDownCast(manager->NewProxy("CMBModelGroup", "ADHExporter"));
  if (!operatorProxy)
  {
...
void vtkADHExporterOperationClient::PrintSelf(ostream& os, vtkIndent indent)
{
