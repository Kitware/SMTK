...
#include "vtkCMBModelFaceMeshOperation.h"
...
vtkStandardNewMacro(vtkCMBModelFaceMeshOperation);

vtkCMBModelFaceMeshOperation::vtkCMBModelFaceMeshOperation()
{
...
void vtkCMBModelFaceMeshOperation::Operate(vtkCMBMeshWrapper* meshWrapper)
{
...
void vtkCMBModelFaceMeshOperation::PrintSelf(ostream& os, vtkIndent indent)
{
