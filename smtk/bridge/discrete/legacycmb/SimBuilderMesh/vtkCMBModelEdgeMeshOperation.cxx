...
#include "vtkCMBModelEdgeMeshOperation.h"
...
vtkStandardNewMacro(vtkCMBModelEdgeMeshOperation);

vtkCMBModelEdgeMeshOperation::vtkCMBModelEdgeMeshOperation()
{
...
void vtkCMBModelEdgeMeshOperation::Operate(vtkCMBMeshWrapper* meshWrapper)
{
  if (this->Id == 0)
  { // id not set
    this->OperateSucceeded = 0;
...
void vtkCMBModelEdgeMeshOperation::PrintSelf(ostream& os, vtkIndent indent)
{
