...
// .NAME vtkSelectionSplitOperationBase - Split a model face based on a vtkSelection.
// .SECTION Description
...
#ifndef __smtkdiscrete_vtkSelectionSplitOperationBase_h
#define __smtkdiscrete_vtkSelectionSplitOperationBase_h
...
class SMTKDISCRETESESSION_EXPORT vtkSelectionSplitOperationBase : public vtkObject
{
public:
  static vtkSelectionSplitOperationBase* New();
  vtkTypeMacro(vtkSelectionSplitOperationBase, vtkObject);
...
protected:
  vtkSelectionSplitOperationBase();
  ~vtkSelectionSplitOperationBase() override;
...
private:
  ...
  vtkSelectionSplitOperationBase(const vtkSelectionSplitOperationBase&); // Not implemented.
  void operator=(const vtkSelectionSplitOperationBase&);                 // Not implemented.
};
