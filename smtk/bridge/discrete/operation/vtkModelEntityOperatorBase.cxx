...
void vtkModelEntityOperatorBase::SetRepresentationRGBA(double R, double G, double B, double A)
{
  double rgba[4] = { R, G, B, A };
...
vtkModelEntity* vtkModelEntityOperatorBase::GetModelEntity(vtkDiscreteModel* Model)
{
