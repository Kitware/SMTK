...
// .NAME vtkMergeOperationBase - Merge two geometric model entities
// .SECTION Description
// Operation to merge a source geometric model entity into
...
#ifndef __smtkdiscrete_vtkMergeOperationBase_h
#define __smtkdiscrete_vtkMergeOperationBase_h
...
class SMTKDISCRETESESSION_EXPORT vtkMergeOperationBase : public vtkObject
{
public:
  static vtkMergeOperationBase* New();
  vtkTypeMacro(vtkMergeOperationBase, vtkObject);
...
protected:
  vtkMergeOperationBase();
  ~vtkMergeOperationBase() override;
...
private:
  ...
  vtkMergeOperationBase(const vtkMergeOperationBase&); // Not implemented.
  void operator=(const vtkMergeOperationBase&);        // Not implemented.
};
