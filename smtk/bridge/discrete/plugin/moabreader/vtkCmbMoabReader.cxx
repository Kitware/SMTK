                ...
                vtkInformationVector *outputVector)
{
  ...
  faceIds->SetName(vtkCMBParserBase::GetModelFaceTagName());
  faceAdjRegionIds->SetName(vtkCMBParserBase::GetModelFaceRegionsMapString());
  domainRegionIds->SetName(vtkCMBParserBase::GetModelPredefinedDomainSets());
  {
