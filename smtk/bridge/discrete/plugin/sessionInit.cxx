...
typedef smtk::extension::paraview::PluginClient<smtk::bridge::discrete::Registrar,
  smtk::resource::Manager, smtk::operation::Manager>
  DiscretePluginClient;
...
static std::shared_ptr<DiscretePluginClient> discrete_client =
  std::dynamic_pointer_cast<DiscretePluginClient>(DiscretePluginClient::create());
