...
int main(int argc, char* argv[])
{
  ...
  smtk::bridge::vtk::Resource::Ptr resource;
  smtk::model::Entity::Ptr modelEntity;

  {
    // Create a read operator
    smtk::bridge::vtk::LegacyRead::Ptr readOp = smtk::bridge::vtk::LegacyRead::create();
    if (!readOp)
    {
    ...
    resource = std::dynamic_pointer_cast<smtk::bridge::vtk::Resource>(resourceItem->value());
